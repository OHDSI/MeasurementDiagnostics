...
As an example, the table below shows the `measurement_value_as_concept` results. From this output, we can see that for this codelist and mock dataset, measurement values are not recorded using concepts.
